...
export const PricingSection = ({ openLeadForm }: PricingSectionProps) => {
  ...
  return (
    <section className="py-12 md:py-24 bg-gradient-to-br from-background via-forumscout-neutral-50 to-background relative overflow-hidden">
      {/* Background elements */}
      ...
      <div className="container px-4 md:px-6 mx-auto relative">
        ...
        <div className="text-center max-w-4xl mx-auto mb-8 md:mb-16">
          <div className="inline-flex items-center gap-2 px-4 py-2 md:px-6 md:py-3 rounded-full bg-forumscout-success-100 border border-forumscout-success-200 mb-4 md:mb-6">
            <Check className="h-4 w-4 md:h-5 md:w-5 text-forumscout-success-600" />
            <span className="text-forumscout-success-700 font-semibold text-sm md:text-lg">No Risk, All Reward</span>
          </div>
          ...
          <p className="text-lg md:text-xl lg:text-2xl text-muted-foreground leading-relaxed mb-6 md:mb-8 px-2">
            Experience Forum Scout risk-free for <span className="font-bold text-forumscout-success-600">14 days</span>. 
            <br className="hidden md:block" />
            Our team creates a <span className="font-bold text-forumscout-primary-600">custom plan</span> that fits your needs.
          </p>
        </div>
        ...
        <div className="max-w-4xl mx-auto mb-8 md:mb-16">
          <div className="relative group">
            {/* Glow effect */}
            <div className="absolute -inset-0.5 bg-gradient-to-r from-forumscout-primary-600 via-forumscout-secondary-600 to-forumscout-primary-600 rounded-3xl blur opacity-20 group-hover:opacity-40 transition duration-500"></div>
            
            <div className="relative bg-gradient-to-br from-white to-forumscout-neutral-50 border-2 border-forumscout-primary-200 rounded-3xl p-6 md:p-8 lg:p-12 text-center">
              <div className="inline-flex items-center justify-center w-16 h-16 md:w-20 md:h-20 rounded-3xl bg-gradient-to-br from-forumscout-primary-500 to-forumscout-secondary-600 shadow-xl mb-6 md:mb-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                ...
                <Button
                  variant="outline"
                  size="lg"
                  className="border-2 border-forumscout-neutral-300 hover:border-forumscout-primary-400 px-6 py-3 md:px-8 md:py-4 text-base md:text-lg w-full sm:w-auto min-h-[48px]"
        ...
        <div className="grid gap-6 md:gap-8 grid-cols-1 md:grid-cols-3 max-w-6xl mx-auto mb-8 md:mb-16">
          {benefits.map((benefit, index) => (
            <div key={index} className="group">
              <div className="relative bg-white border border-forumscout-neutral-200 rounded-2xl p-6 md:p-8 text-center hover:shadow-xl transition-all duration-500 hover:-translate-y-1 md:hover:-translate-y-2 min-h-[200px] md:min-h-[240px] flex flex-col justify-between">
                <div>
        ...
        <div className="text-center max-w-4xl mx-auto">
          <div className="bg-gradient-to-r from-forumscout-neutral-50 to-forumscout-neutral-100 border border-forumscout-neutral-200 rounded-2xl p-6 md:p-8">
            ...
            <div className="grid gap-6 md:gap-8 grid-cols-1 md:grid-cols-3 mb-6 md:mb-8">
              <div className="text-center">
                <div className="text-2xl md:text-3xl font-bold text-forumscout-primary-600 mb-2">Small Teams</div>
                <p className="text-sm md:text-base text-muted-foreground">Perfect for startups</p>
              </div>
              
              <div className="text-center">
                <div className="text-2xl md:text-3xl font-bold text-forumscout-secondary-600 mb-2">Enterprise</div>
                <p className="text-sm md:text-base text-muted-foreground">Scalable solutions</p>
              </div>
              
              <div className="text-center">
                <div className="text-2xl md:text-3xl font-bold text-forumscout-success-600 mb-2">Custom</div>
                <p className="text-sm md:text-base text-muted-foreground">Tailored plans</p>
              </div>
            </div>
            
            <div className="bg-forumscout-primary-50 border border-forumscout-primary-200 rounded-xl p-4 md:p-6">
              <div className="flex items-center justify-center gap-3 mb-3 md:mb-4">
                <Phone className="h-5 w-5 md:h-6 md:w-6 text-forumscout-primary-600" />
                <h4 className="text-base md:text-lg font-semibold text-forumscout-primary-900">Pricing Consultation</h4>
              </div>
              <p className="text-sm md:text-base text-forumscout-primary-700 mb-3 md:mb-4 leading-relaxed">
                Our sales team creates a plan that fits your budget and requirements. 
                Get transparent pricing based on your actual needs.
              </p>
              <p className="text-xs md:text-sm text-forumscout-primary-600 font-medium">
