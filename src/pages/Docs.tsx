...
export default function Docs() {
  ...
  const pageName = "Docs";
  const pageTitle = "Developer Docs";
        ...
        <div className="container px-4 md:px-6 mx-auto">
          <div className="flex flex-col items-center text-center space-y-4 mx-auto max-w-[800px]">
            ...
            <p className="text-muted-foreground md:text-xl max-w-[700px] pt-2">
              The content of our {pageName.toLowerCase()} is exclusively available to ForumScout customers.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-3 pt-6">
              ...
              <Button
                size="lg"
                variant="outline"
                onClick={() => openLeadForm(`docs-placeholder-contact`)}
              >
                Contact Sales
              </Button>
            </div>
