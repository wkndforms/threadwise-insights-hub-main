...
export default function Documentation() {
  ...
  const pageTitle = "Product Documentation";
        ...
        <div className="container px-4 md:px-6 mx-auto">
          <div className="flex flex-col items-center text-center space-y-4 mx-auto max-w-[800px]">
            ...
            <p className="text-muted-foreground md:text-xl max-w-[700px] pt-2">
              The content of the {pageName.toLowerCase()} is exclusively available to ForumScout customers.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-3 pt-6">
              <Button
                size="lg"
                className="mt-8 bg-gradient-to-r from-forumscout-purple to-forumscout-purple-dark hover:opacity-90"
                onClick={() => openLeadForm(`${pageName.toLowerCase()}-placeholder-cta`)}
              >
                Start Free Trial
              </Button>
              <Button
                size="lg"
                variant="outline"
                onClick={() => openLeadForm(`documentation-placeholder-contact`)}
              >
                Contact Sales
              </Button>
            </div>
